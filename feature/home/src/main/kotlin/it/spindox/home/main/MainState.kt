...
val sampleMainState = MainState (
    modelsList = success {
        listOf(
            LlmModelUi(name = "GEMMA3_1B_IT_CPU", "https://pokeapi.co/api/v2/pokemon/1", preferredBackend = LlmInference.Backend.CPU, topP = 0.95f, topK = 64, temperature = 1.0f, isDownloaded = true),
